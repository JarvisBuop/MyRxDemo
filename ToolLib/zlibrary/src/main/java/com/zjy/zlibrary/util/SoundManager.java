 ...
 * the {@link android.media.SoundPool} class and implement your own manager. 
 * 
 * To start, call {@link #initialize(android.content.Context)} to do the initial setup and to allow the SoundManager to 
 * begin accepting {@link #addSound(android.content.Context, int, int)} and {@link #playSound(int)} calls. The SoundManager currently only 
...
public class SoundManager { 
    ...
    /** 
     * Attempts to play the sound identified by soundIdentifier (set by {@link #addSound(android.content.Context, int, int)}) once. 
     * @param soundIdentifier the identifier for the specific sound you are wanting to play (set by 
     * {@link #addSound(android.content.Context, int, int)}). 
    ...
    /** 
     * Attempts to play the sound identified by soundIdentifier (set by {@link #addSound(android.content.Context, int, int)}) the number of times 
